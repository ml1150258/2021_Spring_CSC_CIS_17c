...
Link *newLink(int);         //Create a Link
...
int main(int argc, char** argv) {
    ...
    Link *front;
    //Create the front and fill one at a time
    front=newLink(1);
    //Add to the linked list
    front->linkPtr=newLink(2);
    front->linkPtr->linkPtr=newLink(3);
    front->linkPtr->linkPtr->linkPtr=newLink(4);
    
    //Insert 5 between 2 and 3
    Link *insert=newLink(5);
    insert->linkPtr=front->linkPtr->linkPtr;
    front->linkPtr->linkPtr=insert;
